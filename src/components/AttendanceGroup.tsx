...
const AttendanceGroup: React.FC<AttendanceGroupProps> = ({ type, onBack }) => {
  ...
  const handleEmployeeAbsenClick = () => {
    setSelectedUrl('https://sites.google.com/view/absensi-karyawan-citanduy');
    setShowModal(true);
  };
  ...
  const employeeButtons = [
    ...
    },
    {
      ...
      onClick: () => window.open('https://sites.google.com/view/rekapabsencitanduy/beranda', '_blank'),
      available: true
    },
    {
    ...
    },
    {
      ...
      onClick: () => window.open('https://sites.google.com/view/download-jurnal/citanduy', '_blank'),
      available: true
    }
  ];
